...
const data = [
  ...
  },
  {
    ...
    text: `Our patented water flow algorithm utilized by our state of the art manifold system ensures that your living space is heated as quick as possible, up to 200% faster than competitors without increasing costs.`
  },
  {
...
const Compare = () =>
  <DataTable
    ...
    expandableRowExpanded={row => row.feature === 'More Efficient'}
  />;
